...
def game():
    ...
    print("Think of a country that starts with that letter.\n"
          "Now, think of an animal that starts with the last letter of the country.\n"
          "Finally, a color that starts with the last letter of the animal.")
...
def av():
    i = int(input("To find the average of two numbers, first enter one number: "))
